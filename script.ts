import { h as html } from "./index";
import { render, sig, mem, h as f } from "./solid_monke/solid_monke";
import * as sass from 'sass'

let count = sig(4);
let click = () => { count.set(count() + 1); console.log(count()) };
